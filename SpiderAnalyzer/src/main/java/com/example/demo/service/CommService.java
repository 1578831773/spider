...
public class CommService {
    ...
    public void saveArticle(CommArticle commArticle){
        ...
        commMapper.updateArticleInfo(commArticle);
        recordMapper.addArticleCountByCommArticleId(commArticle.getArticleId(), 1);
    }
    ...
    public int getRecordIdByArticleId(int articleId){
        return commMapper.getRecordIdByArticleId(articleId);
    }
